 ...
 */
    ...
    BOOST_AUTO_TEST_CASE(StringValueTest) {
        ...
        cadf::comms::json::JSONPODValue value1("", val1Str);
        ...
        cadf::comms::json::JSONPODValue value2("", val2Str);
