...
namespace JSONRootNodeTest {
    ...
    struct SetupMocks {
            ...
            fakeit::Mock<cadf::comms::json::JSONValue> mockValue;
    };
     ...
     */
    class MemTestNode: public cadf::comms::json::JSONValue {
        public:
     ...
     */
    class MemExposeRootNode: public cadf::comms::json::JSONRootNode {
        public:
 ...
 */
    ...
    BOOST_FIXTURE_TEST_CASE(AddRootAsChildTest, JSONRootNodeTest::TestFixture) {
        cadf::comms::json::JSONNode node("ChildNode");
        BOOST_REQUIRE_THROW(node.setValue(&root), cadf::comms::json::JSONTreeException);
    }
