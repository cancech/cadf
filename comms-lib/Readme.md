...
* Upon client connecting to the server, the server will send a [cadf::comms::HandshakeInitMessage](include/comms/network/handshake/HandshakeInitMessage.h) indicating the max version of the handshake process the server will support
