 ...
 */
    ...
    BOOST_AUTO_TEST_CASE(StringValueTest) {
        ...
        camb::dom::JSONPODValue value1("", val1Str);
        ...
        camb::dom::JSONPODValue value2("", val2Str);
